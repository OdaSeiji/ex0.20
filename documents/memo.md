...
金型のステータスを、個々人の判断で以下の分を入れてはどうかと言うアイディア
...
`die issue`画面で追加しても、画面遷移しない。
![image](./img/20260416-01.png)
...
- 修理要否の表示は必要ない・・・不要
- 一番上のタイトルをスクロールしても固定する・・・完了
- 各工程をクリックして、内容を確認できるようにする・・・5/14測定、診断部完了
- 承認を拒否した場合の流れ・・・5/14完了、ただし再申請できるか未確認
- 修理ページの作成
- 押出種別でのフィルタリング・・・完了
- 押出指示書のPDFの読み出し・・・完了
- 項目：寸法、成形、傷・・・不要
- 承認者の追加・・・5/15完了
- プレビューすると閉じるボタンが無い
- デフォルトで試打だけ表示してほしい・・・5/15完了
- 測定だけの進捗を確認できるページが欲しい。測定完了時間。
- 診断だけを見るページが欲しい
...
<figure style="text-align:center;">
  <img src="./img/20260515-02.png" width="500">
  <figcaption>ベトナム語でない</figcaption>
</figure>

<figure style="text-align:center;">
  <img src="./img/20260515-03.png" width="500">
  <figcaption>修理計画、修理実績に承認は必要なし</figcaption>
</figure>
...
<figure style="text-align:center;">
  <img src="./img/20260518-04.png" width="500">
  <!-- <figcaption>ベトナム語でない</figcaption> -->
</figure>。
...
<figure style="text-align:center;">
  <img src="./img/20260520-04.png" width="300">
  <!-- <figcaption>測定進捗追加</figcaption> -->
</figure>

原因は、「承認」ボタンを押したときに、エラーか何かが出て、複数回保存されていること。

### 問題点 t_die_diagnosis

これを見ると、ng_actionの内容と、need_fixの状態が整合していない。調整が必要。

```
mysql> select id, inspection_id, die_issue_id, ng_action, need_fix, created_at from t_die_diagnosis;
+----+---------------+--------------+-----------+----------+---------------------+
| id | inspection_id | die_issue_id | ng_action | need_fix | created_at          |
+----+---------------+--------------+-----------+----------+---------------------+
|  1 |             1 |         NULL |         1 |        0 | 2026-05-07 07:49:53 |
|  2 |             2 |         NULL |         2 |        0 | 2026-05-07 07:59:42 |
|  3 |             3 |         NULL |         2 |        0 | 2026-05-08 14:57:55 |
|  4 |             4 |         NULL |         2 |        0 | 2026-05-11 10:02:17 |
|  5 |             9 |         NULL |         2 |        0 | 2026-05-13 07:37:48 |
|  6 |             7 |         NULL |         4 |        0 | 2026-05-13 07:41:35 |
|  7 |            16 |         NULL |         4 |        0 | 2026-05-18 08:01:03 |
|  8 |            15 |            3 |         2 |        0 | 2026-05-18 08:03:59 |
|  9 |             8 |            2 |         2 |        0 | 2026-05-18 08:06:17 |
| 10 |            10 |            1 |         2 |        0 | 2026-05-18 08:10:15 |
| 11 |             5 |         NULL |         1 |        0 | 2026-05-18 08:19:59 |
| 12 |             6 |            4 |         2 |        0 | 2026-05-18 10:21:19 |
| 13 |            17 |            5 |         2 |        0 | 2026-05-18 14:17:21 |
| 14 |            18 |            6 |         4 |        0 | 2026-05-19 08:03:08 |
| 15 |            19 |         NULL |         4 |        0 | 2026-05-19 12:56:58 |
| 16 |            27 |         NULL |         2 |        0 | 2026-05-20 11:02:04 |
| 26 |            24 |         NULL |         1 |        0 | 2026-05-20 11:16:47 |
+----+---------------+--------------+-----------+----------+---------------------+
...
- 測定、診断、修理計画、等は修正できるようにしたい。
- 型材の形状をアイコン化できないか？

### 改善完了

die_diagnosis.html承認した時、ページが戻らない問題、解決。却下の動作も問題なし。
...
- 認証システムを入れる
- 金型の新規登録を日本側でするようにする。 その為には、発注台帳からのコピペ、品番の割り当てが必要になる。（品番IDが必須）
- die_issueの上位になる、テーブルで実施が必要な金型をリスト化して、issueと突き合わせる。

# 2026/05/26

この画面、新規登録が出来ないし、品番が異なる場合も出力してしまっている。
品番がおかしいものの確認、必要。新規登録も必要。

<figure style="text-align:center;">
  <img src="./img/20260526-11 (1).png" width="400">
  <!-- <figcaption>測定進捗追加</figcaption> -->
</figure>

このページは、右側に、最新の押出日、最新の診断内容、の表示が有ったが法が良い。型検提出、工程が有った方がいいかも。

<figure style="text-align:center;">
  <img src="./img/20260526-11 (2).png" width="400">
  <!-- <figcaption>測定進捗追加</figcaption> -->
</figure>
...
ベトナム語表記の追加。※VN後が入っていないところは入力してください。
...
<figure style="text-align:center;">
  <img src="./img/20260528-02.png" width="300">
  <!-- <figcaption>測定進捗追加</figcaption> -->
</figure>

# 2026/05/29

前工程から、何日経っているか、表示できるか？
...
# 作業記録 2026-06-06 〜 2026-06-07

## 2026-06-06（昨日）

### コミット済み（V6.5-2_csv）

- `t_die_handover_progress.csv` データファイルを追加

### 作成済み・未コミット

| ファイル                         | 内容                 |
| -------------------------------- | -------------------- |
| `die_handover_progress.html`     | 型検進捗一覧         |
| `die_startup_report.html`        | 金型立上実績レポート |
| `machine_report.html`            | 設備稼働実績レポート |
| `php/die_handover_progress_php/` | 型検進捗用PHP        |
| `php/report_php/`                | レポート用PHP        |

---

## 2026-06-07（今日）　※ V6.6 コミット・プッシュ済み

### DB変更

| テーブル         | 変更内容                                             |
| ---------------- | ---------------------------------------------------- |
| `t_die_handover` | `ordered_at`（発注日）・`shipped_at`（出荷日）を追加 |

### 新規ファイル

| ファイル           | 内容                                                                                      |
| ------------------ | ----------------------------------------------------------------------------------------- |
| `die_arrival.html` | 金型 到着日入力画面（`m_dies` / `t_die_handover` / `t_die_handover_progress` に同時保存） |
| `die_order.html`   | 発注・出荷日入力画面（型番検索・一括入力・テーブル高さ制限付き）                          |
| `php/die_arrival/` | 到着日入力用PHP                                                                           |
| `php/die_order/`   | 発注・出荷日入力用PHP                                                                     |

### 既存ファイル更新

| ファイル             | 変更内容                                                                                |
| -------------------- | --------------------------------------------------------------------------------------- |
| `handover_list.html` | 発注日・出荷日列追加、型番列を左固定、横スクロール対応                                  |
...
http://10.163.50.17/ex0.20/die_issue_progress.html

で進捗を追いかけようとする場合。動かなくなった金型は、型検が進んでいるかが大事。でも、その画面に遷移後、フィルター掛けるとなるとめんどくさい。出来れば、型検の日付を表示した方がいい。別テーブルに表示するか？

過去古くなると、

http://10.163.50.17/ex0.20/die_progress_list.html

ここに表示されなくなる。例えば、`CQA0T3-V03C`、型検が出ていないのは分かるが、過去の押出結果を見たい。ここに表示されるが、VN製造の日付を付けた方がいい。

<figure style="text-align:center;">
  <img src="./img/20260623-01.png" width="500">
  <!-- <figcaption>測定進捗追加</figcaption> -->
</figure>

http://10.163.50.17/ex0.20/die_inspection.html?press_id=11340&mode=edit
の添付ファイルが拡大しないのは痛いな。

あれ、更新が出来ないか・

<figure style="text-align:center;">
  <img src="./img/20260623-02.png" width="500">
  <!-- <figcaption>測定進捗追加</figcaption> -->
</figure>

```
<br />
<b>Fatal error</b>:  Uncaught PDOException: SQLSTATE[42S22]: Column not found: 1054 Unknown column 'die_diameter' in 'field list' in C:\xampp\htdocs\ex0.20\php\die_register\UpdateDataV2.php:18
Stack trace:
#0 C:\xampp\htdocs\ex0.20\php\die_register\UpdateDataV2.php(18): PDOStatement-&gt;execute(Array)
#1 {main}
...
`ordersheet`ページにまだ押出実績が無い生産指示書は削除できるようにした。この先、既に生産してしまった場合の`ordersheet`の変更の為には、

- その`ordersheet`で生産できないように、生産指示のぺーじを変更する
...
以下の `ordersheet`が品番が無いという理由で入らない。

発注書番号 品番 発行日(YYYY-MM-DD) 納期(YYYY-MM-DD) 数量 備考
P260800406 C2P10K-AB841-20K 2026-08-01 2026-08-31 26 08/2026-BS
P260800407 MB-A0-32-C6781-K 2026-08-01 2026-08-31 1 08/2026-BS
P260800408 MB-80-32-C6780-K 2026-08-01 2026-08-31 1 08/2026-BS
P260800409 P3800603-MH1 2026-08-01 2026-08-31 5 08/2026-BS
P260800410 S370A63T31X25X30 2026-08-01 2026-08-31 2 08/2026-BS
P260800411 S369A63T36X32X30 2026-08-01 2026-08-31 35 08/2026-BS
P260800412 CYV32C-R5503A20K 2026-08-01 2026-08-31 20 08/2026-BS
P260800413 P3315661-M 2026-08-01 2026-08-31 8 08/2026-BS
P260800414 CYP15K-R5500-20K 2026-08-01 2026-08-31 4 08/2026-BS
P260800415 XT686-1-420-1-2M 2026-08-01 2026-08-31 1 08/2026-BS
P260800416 CXS20A-BA023-20K 2026-08-01 2026-08-31 8 08/2026-BS
...
`extrusion_quantity_report.html`(押出重量 実績レポート)を作成。t_press×t_bundle(press_id)をJOINし、押出種別(試押／量産試押／量産)×ビレットサイズ×製造工場(Dubai/VN)別に、月次投入重量を集計。

重量計算式(`get_machine_monthly.php`の`extrusion_t`と同じ):

```sql
PI() * POWER(t_press.billet_size * 25.4 / 2, 2) * t_press.billet_length * t_bundle.quantity * 2.7 / 1000000000
```

billet_size(インチ)→mm変換、密度2.7g/cm³。mfg(製造工場)がNULL/0のレコードとbillet_size=0は集計除外。表示は4月始まり年度で、過去の完了年度は月平均1列に集約、当年度のみ月別展開(トグルボタンで全期間月別展開も可能)。

**手元の実績Excel(材料歩留管理シート)の「投入量」との突合結果:**

添付の`Clipboard02.png`(量産[A]=●量産カテゴリの年度別合計)と、上記システムの計算値(mfg全件込み、pressing_type_id=3)を比較。

| 年度                | Excel記載値 | システム計算値 |              差分 |
| ------------------- | ----------: | -------------: | ----------------: |
| FY22(2022/4-2023/3) |   2,089.9 t |      2,016.0 t |   -73.9 t (-3.5%) |
| FY23(2023/4-2024/3) |     666.3 t |        890.5 t | +224.2 t (+33.6%) |
| FY24(2024/4-2025/3) |   2,162.3 t |      2,222.0 t |   +59.7 t (+2.8%) |
| FY25(2025/4-2026/3) |   2,004.1 t |      2,024.7 t |   +20.6 t (+1.0%) |

わかったこと:

- FY24・FY25はほぼ一致(誤差1〜3%)。計算式(ビレット径インチ→mm換算)・分類の前提は概ね正しいと確認できた。Excel側にも「ビレット径(インチ)」の記載があり、単位の前提一致を確認済み。
- FY22の差(-3.5%)は、`t_bundle.mfg`が2022年4〜12月に集中してNULLになっている(1,284t分)ことが主因とほぼ特定。現行レポートは`mfg IN (1,2)`のみ集計のため、この期間のNULL分を含めると2,016.0tとなりExcelの2,089.9tにかなり近づく(残差73.9tは未解明)。
- FY23の差(+224.2t、システム側が多い)は未解明。偶然か、システム側の「量産テスト(◎)」FY23合計(217.9t)とほぼ同じ大きさであり、一部の押出がシステムでは「量産(●)」、Excel側では「量産テスト」に計上されている、といった分類境界のズレの可能性がある(要個別レコード確認)。
- 「量産テスト」「テスト」カテゴリの年度別合計は、画像内の数値(特にFY22〜24)が小さく不明瞭で正確に読み取れず、突合できていない。正確な比較には元Excelファイル(セル値)が必要。
...
各種設定→金型到着日入力は必要なし。
各種設定→型検進捗一覧　は金型進捗一覧（到着から、移管まで）

http://10.163.50.17/ex0.20/production_number.html
