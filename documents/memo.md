...
金型の進捗を一覧表示できないか、表示したいのは、

- 押出日
- 洗浄日
- 測定日

と言う事で、出してみるのは、品質評価の`SQL`。ここら辺は、もうすっかり忘れて、何を表現しているのか忘れた。どうも、`t_press.dimension_check_date'に寸法評価日が入力されるらしい。
...
![](./img/20250910_01.png)
CYR32E-V01D は何回か押出をしているが、押出履歴が右上に出てこない。

# 2025/09/17

このページ、過去に、写真を貼り付けられるようにした方が良いね。
![](./img/20250917_01.png)
レイアウト的に、上で金型を選んで、
下で、履歴の表と、右側に、画像の一覧、のレイアウトの方がいい。
![](./img/20250917_02.png)
それと、`ZZZ`の取り扱いは、`ZZZ` が無い金型と合算できないか？
